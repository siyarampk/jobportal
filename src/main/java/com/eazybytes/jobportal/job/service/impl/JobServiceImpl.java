...
public class JobServiceImpl implements IJobService {
    ...
    @Transactional
    @Override
    public JobDto updateJobStatus(Long jobId, String status, String employeeEmail) {
        //Validate status
        ...
        JobPortalUser employer = userRepository.findJobPortalUserByEmail(employeeEmail)
                .orElseThrow(() -> new RuntimeException("Employee not found"));
    ...
    @Transactional
    @Override
    public JobDto createJob(JobDto jobDto, String employeeEmail) {
        JobPortalUser employer = userRepository.findJobPortalUserByEmail(employeeEmail)
                .orElseThrow(() -> new RuntimeException("Employer not found"));

        if(employer.getCompany() == null) {
            throw new RuntimeException("Employer does not have a company assigned. Please contact your administrator");
        }
